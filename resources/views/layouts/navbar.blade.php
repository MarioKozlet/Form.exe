    ...
    <!-- Modal -->
    <div class="modal fade" id="modalLogout" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('logout') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak, Terima
                            Kasih</button>
