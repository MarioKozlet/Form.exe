...
<table class="table table-striped table-nowrap">
    ...
    <tr>
        ...
        <td>
            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $u->id }}"> <i class="ti ti-edit fs-3"></i> </button>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="email" name="email" value="{{ $u->email }}" class="form-control" @error('email') is-invalid @enderror>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label class="fw-bold"> Username </label>
                            <input type="text" name="username" value="{{ $u->username }}" class="form-control" @error('username') is-invalid @enderror>
                            <label class="text-muted"> Username dibuat untuk nama yang akan ditampilkan di website </label>
                        </div>
                        <div class="col">
                            <label class="fw-bold"> Name </label>
                            <input type="text" class="form-control" value="{{ $u->name }}" name="name" @error('name') is-invalid @enderror>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            ...
                            <label class="text-muted"> Password Tidak Bisa Diedit, tapi bisa dibuat ulang, karena password yg ada telah dihash untuk keamanaan akun </label>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
